...
label char_kit_update:
    ...
    if char_kit_checkpoint == 1:
        $ persistent.kit_profile = CharacterProfile(name="Kit", imageName="kit_model normal shut", desc = "test", trueName = "kit")
        return
...
label char_vida_update:
    ...
    if char_vida_checkpoint == 1:
        $ persistent.vida_profile = CharacterProfile(name="Vida", imageName="vida_model normal shut", desc = "test", trueName = "vida")
        return
...
label char_andrea_update:
    ...
    if char_andrea_checkpoint == 1:
        $ persistent.andrea_profile = CharacterProfile(name="Andrea", imageName="andrea_model normal shut", desc = "???", trueName = "andrea")
        return
...
label char_manic_update:
    ...
    if char_manic_checkpoint == 1:
        $ persistent.manic_profile = CharacterProfile(name="???", imageName="manic_model normal shut", desc = "???", trueName = "manic")
        return
    elif char_manic_checkpoint == 2:
        $ persistent.manic_profile = CharacterProfile(name="Manic", imageName="manic_model normal shut", desc = "test", trueName = "manic")
        return
...
label char_neda_update:
    ...
    if char_neda_checkpoint == 1:
        $ persistent.neda_profile = CharacterProfile(name="Neda", imageName="neda_model normal shut", desc = "test", trueName = "neda")
        return
